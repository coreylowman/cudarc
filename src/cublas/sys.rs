...
fn bindgen_test_layout_float2() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<float2>())).x as *const _ as usize },
        0usize,
        concat!("Offset of field: ", stringify!(float2), "::", stringify!(x))
    );
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<float2>())).y as *const _ as usize },
        4usize,
...
fn bindgen_test_layout_double2() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<double2>())).x as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(double2),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<double2>())).y as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(double2),
