...
// wrappers
extern "C" void test_halfs(__half h) {
    halfs<<<1, 1>>>(h);
}
...
extern "C" void test_int_8bit(signed char s_min, char s_max, unsigned char u_min, unsigned char u_max) {
    int_8bit<<<1, 1>>>(s_min, s_max, u_min, u_max);
}

extern "C" void test_int_16bit(signed short s_min, short s_max, unsigned short u_min, unsigned short u_max) {
    int_16bit<<<1, 1>>>(s_min, s_max, u_min, u_max);
}

extern "C" void test_int_32bit(signed int s_min, int s_max, unsigned int u_min, unsigned int u_max) {
    int_32bit<<<1, 1>>>(s_min, s_max, u_min, u_max);
}

extern "C" void test_int_64bit(signed long s_min, long s_max, unsigned long u_min, unsigned long u_max) {
    int_64bit<<<1, 1>>>(s_min, s_max, u_min, u_max);
}

extern "C" void test_floating(float f, double d) {
    floating<<<1, 1>>>(f, d);
}
